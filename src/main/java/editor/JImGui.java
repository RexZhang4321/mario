...
public class JImGui {
    ...
    public static void drawVec3Control(String label, Vector3f values, float resetValue, float columnWidth) {
        ...
        ImGui.pushStyleColor(ImGuiCol.ButtonHovered, 0.3f, 0.3f, 0.7f, 1.0f);
    ...
    public static void drawVec4Control(String label, Vector4f values) {
        drawVec4Control(label, values, 0.0f, DEFAULT_COLUMN_WIDTH);
    }

    public static void drawVec4Control(String label, Vector4f values, float resetValue) {
        drawVec4Control(label, values, resetValue, DEFAULT_COLUMN_WIDTH);
    }
    ...
    public static void drawVec4Control(String label, Vector4f values, float resetValue, float columnWidth) {
        ...
        ImGui.pushItemWidth(widthEach);
        ImGui.pushStyleColor(ImGuiCol.Button, 0.7f, 0.2f, 0.7f, 1.0f);
        ImGui.pushStyleColor(ImGuiCol.ButtonHovered, 0.8f, 0.3f, 0.7f, 1.0f);
        ImGui.pushStyleColor(ImGuiCol.ButtonActive, 0.7f, 0.2f, 0.7f, 1.0f);
    ...
    public static boolean checkBoxBoolean(String label, boolean value) {
        ImGui.pushID(label);
        ...
        ImBoolean val = new ImBoolean(value);
        ImGui.checkbox("##checkBoxBoolean", val);
